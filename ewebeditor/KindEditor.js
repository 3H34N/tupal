...
var KE_TITLE_value = '<div style="width:140px;cursor:pointer;" onclick="javascript:KindExecute(\'KE_TITLE_END\', \'H1\');" onmouseover="javascript:this.style.backgroundColor=\'#CCCCCC\';" onmouseout="javascript:this.style.backgroundColor=\'#EFEFEF\';"><H1 style="margin:2px;">标题 1</H1></div><div style="width:140px;cursor:pointer;" onclick="javascript:KindExecute(\'KE_TITLE_END\', \'H2\');" onmouseover="javascript:this.style.backgroundColor=\'#CCCCCC\';" onmouseout="javascript:this.style.backgroundColor=\'#EFEFEF\';"><H2 style="margin:2px;">标题 2</H2></div><div style="width:140px;cursor:pointer;" onclick="javascript:KindExecute(\'KE_TITLE_END\', \'H3\');" onmouseover="javascript:this.style.backgroundColor=\'#CCCCCC\';" onmouseout="javascript:this.style.backgroundColor=\'#EFEFEF\';"><H3 style="margin:2px;">标题 3</H3></div><div style="width:140px;cursor:pointer;" onclick="javascript:KindExecute(\'KE_TITLE_END\', \'H4\');" onmouseover="javascript:this.style.backgroundColor=\'#CCCCCC\';" onmouseout="javascript:this.style.backgroundColor=\'#EFEFEF\';"><H4 style="margin:2px;">标题 4</H4></div><div style="width:140px;cursor:pointer;" onclick="javascript:KindExecute(\'KE_TITLE_END\', \'H5\');" onmouseover="javascript:this.style.backgroundColor=\'#CCCCCC\';" onmouseout="javascript:this.style.backgroundColor=\'#EFEFEF\';"><H5 style="margin:2px;">标题 5</H5></div><div style="width:140px;cursor:pointer;" onclick="javascript:KindExecute(\'KE_TITLE_END\', \'H6\');" onmouseover="javascript:this.style.backgroundColor=\'#CCCCCC\';" onmouseout="javascript:this.style.backgroundColor=\'#EFEFEF\';"><H6 style="margin:2px;">标题 6</H6></div>';
...
function KindInsertImageP8FLV(url, width, height, cmd)
{
	...
	if(cmd=='KE_FLV'){
		...
		str="<a style=\"COLOR: red\" href='"+url+"' target=_blank p8name=\"p8download\">点击下载</a>";
	}else{
		str='take a test';
	}
