...
if($job=="admin_logs"&&$Apower[logs_admin_do_logs])
{
	...
	//require(dirname(__FILE__)."/"."template/logs/menu.htm");
	require(dirname(__FILE__)."/"."template/logs/admin_logs.htm");
...
elseif($job=="login_logs"&&$Apower[logs_login_logs])
{
	...
	require(dirname(__FILE__)."/"."head.php");
	//require(dirname(__FILE__)."/"."template/logs/menu.htm");
	require(dirname(__FILE__)."/"."template/logs/login_logs.htm");
	require(dirname(__FILE__)."/"."foot.php");
}
