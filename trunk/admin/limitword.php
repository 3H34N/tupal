...
if($job=="list"&&$Apower[limitword_list])
{
	...
	require(dirname(__FILE__)."/"."template/limitword/menu.htm");
	require(dirname(__FILE__)."/"."template/limitword/list.htm");
...
elseif($job=="edit"&&$Apower[limitword_list])
{
	...
	require(dirname(__FILE__)."/"."head.php");
	require(dirname(__FILE__)."/"."template/limitword/menu.htm");
	require(dirname(__FILE__)."/"."template/limitword/edit.htm");
	require(dirname(__FILE__)."/"."foot.php");
}
...
elseif($job=="addall"&&$Apower[limitword_list])
{
	require(dirname(__FILE__)."/"."head.php");
	require(dirname(__FILE__)."/"."template/limitword/menu.htm");
	require(dirname(__FILE__)."/"."template/limitword/addall.htm");
	require(dirname(__FILE__)."/"."foot.php");
}
elseif($job=="replace"&&$Apower[limitword_replace])
{
	require(dirname(__FILE__)."/"."head.php");
	//require("template/limitword/menu.htm");
	require(dirname(__FILE__)."/"."template/limitword/replace.htm");
	require(dirname(__FILE__)."/"."foot.php");
}
